/*  File name: testBuffer.c
 *  Purpose: This is the main program for Assignment #1, CST8152
 *  Version: 2.01
 *  Author: Svillen Ranev - Reviewer: Paulo Sousa
 *  Date: 1 May 2020 - Update: 17th Sep 2020
 */
...
int main(int argc, char** argv) {
 ...
 /* __DATE__, __TIME__, __LINE__, __FILE__, __STDC__ are predefined preprocessor macros*/
	...
	ptr_Buffer = bufferCreate(0, 0, *argv[2]);
	if (ptr_Buffer == NULL) {
	...
	loadsize = bufferLoad(fi, ptr_Buffer);
